		...
		<div class="collapse navbar-collapse" id="myMenu">
			<ul class="navbar-nav ml-auto navbar-nav--menu">
				...
				<li class="nav-item"><a class="nav-link" href="#">TIN TỨC</a>
					<div class="nav-item__line"></div></li>
				<li class="nav-item"><a class="nav-link" href="#">THỦ TỤC</a>
					<div class="nav-item__line"></div></li>
				<li class="nav-item"><a class="nav-link" href="thudientu.html">THƯ
						ĐIỆN TỬ</a>
					<div class="nav-item__line"></div></li>
				<li class="nav-item "><a class="nav-link" data-toggle="modal"
					data-target="#modal-carousel" href="#">TRA CỨU & GỬI TIẾP NHẬN</a>
					<div class="nav-item__line"></div></li>
...
<!-- MODAL POPUP -->
<c:choose>
  <c:when test="${hello==null}">
   <div class="modal fade " id="modal-carousel">
   

  </c:when>
   <c:when test="${hello=='sai'}">
   <div class="modal fade show " id="modal-carousel" style="display: block">
